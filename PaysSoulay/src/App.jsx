...
function App() {
  ...
  return (
    <div className='h-full w-[100%] bg-slate-200 flex justify-center gap-7 flex-wrap'>
      <div className='w-full bg-white flex justify-between p-6'>
        <div>
          <h1 className='font-bold text-3xl'>Where is the world?</h1>
        </div>
        <div>
      ...
      <div className='w-full h-14 flex justify-center items-center p-6'>
        <div className='flex w-[87%] justify-between'>
          <label className="input input-bordered flex items-center gap-2">
              ...
              <input type="text" className="grow" placeholder="Search for a country..." />
          </label>
      ...
      </div>
      {
        pays.map((pays, key) => {
          return(
            <div className='cardy w-[20%] bg-white rounded-xl justify-center items-center'>

              <div className='h-72 w-full flex flex-col  rounded-xl'>
                <div className='h-[50%] bg-purple-600 rounded-t-xl'>
